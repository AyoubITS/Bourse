...
public class GUI2 extends JFrame {
	...
	public GUI2() {
		...
		/**
		 * On créer un bouton pour revenir à l'interface précèdente
		 */
		JButton b1ereinterface = new JButton("Revenir à l'interface précédente");
		 b1ereinterface.addActionListener(new ActionListener() {
			 /**
			  * @param e 
			  * ce paramètre permet de lancer l'action pour revenir a l'interface précédente
			  */
		...
		/**
		 * On créer notre ListModel ou l'on remplis les entreprises.
		 */
		...
		/**
		 * On créer notre ListModelVente avec le nombre d'actions que l'on peut vendre
		 */
		...
		/**
		 * On créer notre bouton pour choisir notre entreprise a afficher
		 */
		...
		/**
		 * On créer un JTextField pour présenter la partie Achat
		 */
		...
		/**
		 * On créer une Jlist pour afficher le choix des entreprises pour acheter , on rajoute une JScrollPane pour une meilleure visibilité.
		 */
		...
		/**
		 * On créer une Jlist pour décider du nombre d'action que l'on achetera.
		 */
		...
		/**
		 * On créer une JTextField pour présenter la partie Vente.
		 */
		...
		/**
		 * On créer notre Jlist pour la vente de nos entreprise avec une JscollPane pour plus de visibilité
		 */
		...
		/**
		 * On créer notre Jlist pour la vente du nb action
		 */
	...
	for (int i=0; i<listModel_vente_entreprise.getSize();i++) {
		...
		/**
		 * Créer notre bouton qui va lancer la simulation
		 */
		...
		/**
		 * Créer notre JList ou on affichera l'historique de nos achats avec unne JScrollPane pour une meilleure visibilité.
		 */
		...
		/**
		 * Créer un separateur pour une meilleure visibilité.
		 */
		...
		/**
		 * Créer un JTextField pour présenter la partie action possédé par l'utilisateur
		 */
		...
		/**
		 * On créer deux JList avec deux JScrollPane ,une  avec le nom des entreprises ou l'on aura acheter, et l'autre avec le nombre d'actions possédés.
		 */
