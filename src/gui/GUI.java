...
/**
 * GUI est la classe représentant la première fenêtre de notre interface graphique
 * 
...
public class GUI extends JFrame {
	...
	public GUI() {
		...
		JButton bAchatVente = new JButton("Accéder à Achat/Vente");
		...
		/**
		 * On crée notre bouton qui va lancer notre simulation.
		 */
		...
		bPlay.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {				
				...
				if (randomElement == 0) {
					listModel2.addElement("Evenement de cette semaine : "+ Evenement.evenementAleatoireGaz()+ ", secteur touché : GAZ - 30%");
					singleton.modifier_capital_secteur(0.7,"gaz");
					singleton.modifier_prix_action_secteur(0.7, "gaz");
			
				}
				else if (randomElement == 1) {
					listModel2.addElement("Evenement de cette semaine : "+ Evenement.evenementAleatoireTransport()+ ", secteur touché : TRANSPORT - 30%");
					singleton.modifier_capital_secteur(0.7,"transport");
					singleton.modifier_prix_action_secteur(0.7, "transport");
					
				}
				else if(randomElement == 2) {
					listModel2.addElement("Evenement de cette semaine : "+ Evenement.evenementAleatoireAutomobile()+ ", secteur touché : AUTOMOBILE +30%");
					singleton.modifier_capital_secteur(1.3,"gaz");
					singleton.modifier_prix_action_secteur(1.3, "gaz");
				}
				else if(randomElement == 3) {
					listModel2.addElement("Evenement de cette semaine : "+Evenement.evenementAleatoireAutomobileNegatif()+ ", secteur touché : AUTOMOBILE - 30%");
					...
					listModel2.addElement("Evenement de cette semaine : "+Evenement.evenementAleatoireInformatique()+ ", secteur touché : INFORMATIQUE +30%");
					...
					System.out.println("Evenement de cette semaine : "+ Evenement.evenementAleatoireInformatiqueNegatif()+ ", secteur touché : INFORMATIQUE - 30%");
		...
		/**
		 * Crée un separateur pour une meilleure visibilité.
		 */
		...
		/**
		 * Créer une Jlist qui contiendra nos entreprises favorites, on rajoute une meilleure visibilité avec la JscrollPane.
		 */
		...
		@SuppressWarnings({ "rawtypes", "unchecked" })
		/**
		 * On crée notre List news avec une JscrollPane pour plus de visibilité, celle ci nous permettra d'afficher toute les news nécessaire à l'augmentation ou la baisse des actions d'une entreprise.
		 */
