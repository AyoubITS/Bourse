...
public class ListEntreprise implements InterfaceEntreprise {
	 ...
	 /**
	  * crée deux arrayList : une entreprise et une d'achat d'action.
	  */
	...
	/**
	 * @param entreprise
	 * méthode qui ajoute une entreprise
	 */
	...
	/**
	 * @param entreprise
	 * méthode qui teste si l'entreprise est dans l'arrayList
	 */
	...
	/**
	 * @return permet de tester plusieurs méthodes
	 */
...
/**
 * Cette méthode nous permet d'ajouter nos entreprises a notre arrayList
 * @param entreprise
 */
	...
	/**
	 * @return le prix modifier de la valeur de l'action après un evenement ou achat d'un utilisateur
	 * @param pourcentage
	 * @param entreprise
	 */
	...
	/**
	 * @return le pourcentage modifier de l'entreprise après que l'utilisateur ait acheter des actions. 
	 * @param valeur3
	 * @param nom
	 */
	...
	public void Achat( int nb_action) {
		...
		if (rep.contentEquals("o")) {
			...
			while(it.hasNext()) {
				...
				if(ent.getNom().contentEquals(entr)) {
					...
					if(nb_action*ent.getValeuraction() > Utilisateur.getSoldeActuel()) {
						...
						System.out.println("Nouvel Achat effectué: " + nb_action + " action(s) chez " + ent.getNom() + " a " + nb_action*ent.getValeuraction()+ "euros.   "  +"Nouveau Solde:"+ Utilisateur.getSoldeActuel());
					}
				}
			}
			...
			System.out.println("Aucune action effectuée cette semaine.");
		}
		else {
			System.out.println("Erreur, réponse attendue : o/n");
		}
	}
