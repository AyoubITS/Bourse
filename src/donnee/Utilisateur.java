...
/**
 * Utilisateur est la classe représentant l'utilisateur qui pourra acheter et vendre des actions.
 * 
 * @param soldeActuel definit notre Solde de l'utilisateur soit 2000 euro.
 * @param pourcentagedetenuparlutilisateur definit notre pourcentage détenu dans l'entreprise.
 */
...
public class Utilisateur {
	 ...
	 * @param pourcentagedetenuparlutilisateur définit le pourcentage detenu par l'utilisateur.
	 * 
	 */
