...
public class AchatAction {
	...
	/**
	 * méthode qui change le nom de l'entreprise
	 * @param nomEntreprise
	 */
	...
	/**
	 * 
	 * @return le nombre d'action possédé
	 */
	...
	/**
	 * méthode qui change le nombre d'action possédé
	 * @param nbAction
	 */
	...
	@Override
	/**
	 * Retourne l'entreprise et le nombre d'action possédé.
	 */
